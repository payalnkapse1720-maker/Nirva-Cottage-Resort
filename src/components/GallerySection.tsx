    ...
    <section id="gallery" className="py-24 md:py-32 bg-[#F1E9DA] relative">
      ...
      {lightboxIndex !== null && (
        ...
        >
          ...
          <button
            onClick={closeLightbox}
            className="absolute top-6 right-6 p-3 rounded-full bg-[#FBF8F1]/20 text-white hover:bg-[#C99A4A] hover:text-[#2F241C] transition-colors z-10 cursor-pointer"
          ...
          <button
            ...
            className="absolute left-4 sm:left-8 top-1/2 -translate-y-1/2 p-3 rounded-full bg-[#FBF8F1]/20 text-white hover:bg-[#C99A4A] hover:text-[#2F241C] transition-colors z-10 cursor-pointer"
          ...
          <button
            ...
            className="absolute right-4 sm:right-8 top-1/2 -translate-y-1/2 p-3 rounded-full bg-[#FBF8F1]/20 text-white hover:bg-[#C99A4A] hover:text-[#2F241C] transition-colors z-10 cursor-pointer"
          ...
          >
            ...
            <div className="absolute bottom-2 bg-[#3E2F24]/85 backdrop-blur-md px-6 py-2 rounded-full border border-[#D8C6A8]/40 text-center">
              <span className="text-xs uppercase tracking-widest text-[#E6D8C2] block">
